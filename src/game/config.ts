export const CONFIG = {
  ...
  COLORS: {
    ...
    ENEMY_TERRAIN: '#8A8A6A',
    ENEMY_TERRAIN_INDESTRUCTIBLE: '#565A5E',
    ENEMY_TERRAIN_EXPLOSIVE: '#B87A2E',
    ENEMY_TURRET: '#FF8844',
    ENEMY_TURRET_CHARGE: '#FF5522',
    ENEMY_REFLECTOR: '#1FA8C4',
    ENEMY_REFLECTOR_ACTIVE: '#7FF8E0',
    ENEMY_SHIELD: '#2299FF',
    ...
    BOSS_MECH: '#C64B4B',
    BOSS_MECH_SPARK: '#FFD27A',
    BOSS_MECH_DRONE: '#7A7A56',
    BOSS_CARRIER: '#4488CC',
    BOSS_CARRIER_CORE: '#FFFFFF',
    BOSS_CARRIER_BAY: '#FFD000',
  },
